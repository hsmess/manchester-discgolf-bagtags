                ...
                <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Your registration is not complete until you have paid. Please note that registration is first-come first-serve. There are 72 available places, and your confirmation email will state what place you are.</p>
                            <p class="mt-2 text-sm text-gray-500">Can't make it? You can get a refund until 25 May 2022 by getting in contact with Iain McDougall.</p>
                        </div>
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="text-sm font-medium text-gray-900">
                                            <span >Thank You! We got your payment!</span>
                                        </p>
