            ...
            <div class="relative py-16 bg-white overflow-hidden">
                ...
                <div class="relative px-4 sm:px-6 lg:px-8">
                    <div class="text-lg max-w-prose mx-auto">
                        ...
                        <p class="mt-8 text-xl text-gray-500 leading-8">The tournament will be sponsored by Ace Disc Golf; Payouts will be in the form of Ace Vouchers for all divisions, as well as having Ace's tremendous retail shop and tournament tent present at both days of the event.</p>
                        <p class="mt-8 text-xl text-gray-500 leading-8">
                            This event is Stop #4 of 5 on the 2022 BDGA Amateur tour - meaning that there are British Championships invites available for the winner of MA2, MA3, FA2, and FA3 divisions.
                            You will also gain points in your seasonal point race, excluding MA4 and FA4.
                        </p>
                    </div>
                    <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                        <h2 class="text-rose-500" style="margin-bottom: 10px !important;">What to expect?</h2>
                        <p>Saturday 2nd July - 2x18 holes on our brand new course at Lilford Park, Leigh. Battle the woods at our new venue!</p>
                        <p>Sunday 3rd July - 1x18 hole round plus a final 9 for top 5 in each division on our tournament layouts at Longford Park, Manchester, the course you know and love.</p>
                        <figure>
                            <img class="w-full rounded-lg" src="https://dontshootdg.s3.eu-west-2.amazonaws.com/PRESENTED+BY+(3).png" alt="" width="1310" height="873">
                            <figcaption>Lilford Park, Leigh is a new wooded course!</figcaption>
                        </figure>
                        <h2 class="text-rose-500" style="margin-bottom: 10px !important;">Divisons and costs</h2>
                        <p>We will be offering the MA1, MA2, MA3 and MA4 divisions as well as FA1, FA2, FA3 and FA4 on the 18th of April.  If the tournament has available places remaining on 18th May 2022 we will open age-protected divisons as these divisions also have their own event the prior weekend. There will be no open division at this event, but Open players with ratings of 970 and below are welcome to play MA1 as per PDGA rules. </p>
                        <p>The final decisions on course layouts for divisions has not yet been decided, but we expect that FA3, FA4 and MA4 will all play a red tee layout at both courses, whereas all other divisions will play a Blue Tee layout at both courses.</p>
                        <p>The cost to play this event will be £35.00 which will get you a players pack with a premium plastic disc in as well as another item, access to both venues, trophy certificates and access to a modest prize pool.</p>
                        <p>Also included in your cost is a contribution towards the Lilford Park course installation that we are expediting to allow for this tournament to be run there!</p>
                        <figure>
                            <img class="w-full rounded-lg" src="https://dontshootdg.s3.eu-west-2.amazonaws.com/PRESENTED+BY+(4).png" alt="" width="1310" height="873">
                            <figcaption>Longford park, the tournament course you all know and love!</figcaption>
                        </figure>
                        <h2 class="text-rose-500" style="margin-bottom: 10px !important;">Other critical info:</h2>
                        <p>There will be some kind of subsidised (but not free) transport to Lilford for those without cars leaving from Longford Park early on the Saturday morning. Please indicate on registration if you may need this so we can get numbers for costs.</p>
                        <p>We are suggesting therefore if you are looking for accommodation and relying on public transport that you stay near Longford Park on the Saturday Night</p>
                        <p>We will run some kind of social event on the Saturday evening, which will probably involve getting an event space close to Longford Park that will let us screen the US Womens Championship on the TV, as well as some food or drinks. Please bear that in mind!</p>
