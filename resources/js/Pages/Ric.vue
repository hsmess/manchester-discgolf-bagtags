...
<!--                                                      </span>-->
<!--                                                      <span class="mt-0.5 ml-4 min-w-0 flex flex-col">-->
<!--                                                        <span class="text-xs font-semibold text-rose-400 tracking-wide uppercase">Get your Tag</span>-->
<!--                                                        <span class="text-sm font-medium text-gray-500">Give us some details</span>-->
<!--                                                      </span>-->
<!--                                                    </span>-->
<!--                                                </a>-->
...
<!--                                        <div> 1x 2022 Manchester Bag Tag - <span class="text-gray-900 text-lg">£{{ tagCost }}</span></div>-->
<!--                                        <div> 1x 2022 MDG Membership - <span class="text-gray-900 text-lg">£0.00</span></div>-->
...
<!--                                                Please select your options, and then click next to proceed to the fundraiser. Buying a bagtag also gets you Manchester Disc Golf membership for 2022.-->
<!--                                            </p>-->
<!--                                        </div>-->
<!--                                        <div class="mt-5 md:mt-0 md:col-span-2">-->
<!--                                            <form class="space-y-6" action="#" method="POST">-->
<!--&lt;!&ndash;                                                <div>&ndash;&gt;-->
<!--&lt;!&ndash;                                                    <label class="block text-sm font-medium text-gray-700">&ndash;&gt;-->
<!--&lt;!&ndash;                                                        Profile Picture (optional)&ndash;&gt;-->
<!--&lt;!&ndash;                                                    </label>&ndash;&gt;-->
<!--&lt;!&ndash;                                                    <div class="mt-1 flex items-center space-x-5">&ndash;&gt;-->
<!--&lt;!&ndash;                                                          <span class="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">&ndash;&gt;-->
<!--&lt;!&ndash;                                                            <svg class="h-full w-full text-gray-300" fill="currentColor" viewBox="0 0 24 24" v-if="profile_picture: null">&ndash;&gt;-->
<!--&lt;!&ndash;                                                              <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />&ndash;&gt;-->
<!--&lt;!&ndash;                                                            </svg>&ndash;&gt;-->
<!--&lt;!&ndash;                                                          </span>&ndash;&gt;-->
<!--&lt;!&ndash;                                                        <button type="button" class="bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-300">&ndash;&gt;-->
<!--&lt;!&ndash;                                                            Change&ndash;&gt;-->
<!--&lt;!&ndash;                                                        </button>&ndash;&gt;-->
<!--&lt;!&ndash;                                                    </div>&ndash;&gt;-->
<!--&lt;!&ndash;                                                </div>&ndash;&gt;-->
...
<!--                                                            <input id="collection" value="collection" name="collection" type="radio" v-model="collection" class="focus:ring-rose-300 h-4 w-4 text-rose-400 border-gray-300">-->
<!--                                                            <label for="collection" class="ml-3 block text-sm font-medium text-gray-700">-->
<!--                                                                Collect from Manchester Disc Golf (+£0.00)-->
<!--                                                            </label>-->
<!--                                                        </div>-->
<!--                                                        <div class="flex items-center">-->
<!--                                                            <input id="shipping" value="shipping" name="collection" type="radio" v-model="collection" class="focus:ring-rose-300 h-4 w-4 text-rose-400 border-gray-300">-->
...
<!--                                                            <input v-model="address_line_1" type="text" name="address_line_1" id="address_line_1" autocomplete="address_line_1" class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">-->
<!--                                                        </div>-->
<!--                                                        <div class="col-span-6">-->
<!--                                                            <label for="address_line_2" class="block text-sm font-medium text-gray-700">Address Line 2</label>-->
<!--                                                            <input  v-model="address_line_2" type="text" name="address_line_2" id="address_line_2" autocomplete="address_line_2" class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">-->
<!--                                                        </div>-->

<!--                                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">-->
<!--                                                            <label for="city" class="block text-sm font-medium text-gray-700">City</label>-->
<!--                                                            <input v-model="city" type="text" name="city" id="city" class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">-->
<!--                                                        </div>-->

<!--                                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">-->
<!--                                                            <label for="County" class="block text-sm font-medium text-gray-700">County</label>-->
<!--                                                            <input v-model="county" type="text" name="County" id="County" class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">-->
<!--                                                        </div>-->

<!--                                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">-->
<!--                                                            <label for="postcode" class="block text-sm font-medium text-gray-700">Postcode</label>-->
<!--                                                            <input v-model="postcode" type="text" name="postcode" id="postcode" autocomplete="postal-code" class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">-->
<!--                                                        </div>-->
<!--                                                    </div>-->
<!--                                                </fieldset>-->
<!--                                            </form>-->
...
<!--                                        <div class="flex-shrink-0 flex items-center justify-center w-16 bg-rose-600 text-white text-sm font-medium rounded-l-md">-->
<!--                                            £100.00-->
<!--                                        </div>-->
<!--                                        <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">-->
<!--                                            <div class="flex-1 px-4 py-2 text-sm truncate">-->
<!--                                                <span class="text-gray-900 font-medium hover:text-gray-500">Mini Basket</span>-->
...
<!--                                        </div>-->
<!--                                    </li>-->
<!--                                    <li @click="donation += 600" class="col-span-1 flex shadow-sm rounded-md">-->
<!--                                        <div class="flex-shrink-0 flex items-center justify-center w-16 bg-rose-600 text-white text-sm font-medium rounded-l-md">-->
<!--                                            £600.00-->
<!--                                        </div>-->
<!--                                        <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">-->
...
<!--                                        <div class="flex-shrink-0 flex items-center justify-center w-16 bg-rose-700 text-white text-sm font-medium rounded-l-md">-->
<!--                                            Custom-->
<!--                                        </div>-->
<!--                                        <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">-->
<!--                                            <div class="flex-1 px-4 py-2 text-sm truncate">-->
